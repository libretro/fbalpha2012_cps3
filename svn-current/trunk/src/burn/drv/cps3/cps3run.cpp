...
UINT8 __fastcall cps3VidReadByte(UINT32 addr)  { return 0; }
UINT16 __fastcall cps3VidReadWord(UINT32 addr) { return 0; }
UINT32 __fastcall cps3VidReadLong(UINT32 addr) { return 0; }
